...
local BASE_MESSAGE = protobuf.Descriptor();
local BASE_MESSAGE_FROM_FIELD = protobuf.FieldDescriptor();
local BASE_MESSAGE_TARGET_FIELD = protobuf.FieldDescriptor();
local BASE_MESSAGE_MESSAGE_FIELD = protobuf.FieldDescriptor();
...
local BASE_MSGTYPE_EMESSAGE_ENUM = protobuf.EnumValueDescriptor();
...
BASE_MESSAGE_FROM_FIELD.name = "from"
BASE_MESSAGE_FROM_FIELD.full_name = ".CommsMessages.Base.Message.from"
BASE_MESSAGE_FROM_FIELD.number = 1
BASE_MESSAGE_FROM_FIELD.index = 0
BASE_MESSAGE_FROM_FIELD.label = 2
BASE_MESSAGE_FROM_FIELD.has_default_value = false
BASE_MESSAGE_FROM_FIELD.default_value = 0
BASE_MESSAGE_FROM_FIELD.type = 5
BASE_MESSAGE_FROM_FIELD.cpp_type = 1

BASE_MESSAGE_TARGET_FIELD.name = "target"
BASE_MESSAGE_TARGET_FIELD.full_name = ".CommsMessages.Base.Message.target"
BASE_MESSAGE_TARGET_FIELD.number = 2
BASE_MESSAGE_TARGET_FIELD.index = 1
BASE_MESSAGE_TARGET_FIELD.label = 2
BASE_MESSAGE_TARGET_FIELD.has_default_value = false
BASE_MESSAGE_TARGET_FIELD.default_value = 0
BASE_MESSAGE_TARGET_FIELD.type = 5
BASE_MESSAGE_TARGET_FIELD.cpp_type = 1

BASE_MESSAGE_MESSAGE_FIELD.name = "message"
BASE_MESSAGE_MESSAGE_FIELD.full_name = ".CommsMessages.Base.Message.message"
BASE_MESSAGE_MESSAGE_FIELD.number = 3
BASE_MESSAGE_MESSAGE_FIELD.index = 2
BASE_MESSAGE_MESSAGE_FIELD.label = 2
BASE_MESSAGE_MESSAGE_FIELD.has_default_value = false
BASE_MESSAGE_MESSAGE_FIELD.default_value = ""
BASE_MESSAGE_MESSAGE_FIELD.type = 9
BASE_MESSAGE_MESSAGE_FIELD.cpp_type = 9

BASE_MESSAGE.name = "Message"
BASE_MESSAGE.full_name = ".CommsMessages.Base.Message"
BASE_MESSAGE.nested_types = {}
BASE_MESSAGE.enum_types = {}
BASE_MESSAGE.fields = {BASE_MESSAGE_FROM_FIELD, BASE_MESSAGE_TARGET_FIELD, BASE_MESSAGE_MESSAGE_FIELD}
BASE_MESSAGE.is_extendable = false
BASE_MESSAGE.extensions = {}
BASE_MESSAGE.containing_type = BASE
...
BASE_MSGTYPE_EMESSAGE_ENUM.name = "EMessage"
BASE_MSGTYPE_EMESSAGE_ENUM.index = 3
BASE_MSGTYPE_EMESSAGE_ENUM.number = 4
...
BASE_MSGTYPE.values = {BASE_MSGTYPE_EPING_ENUM,BASE_MSGTYPE_EREGISTER_ENUM,BASE_MSGTYPE_EREGISTERED_ENUM,BASE_MSGTYPE_EMESSAGE_ENUM,BASE_MSGTYPE_EMOVEMENT_ENUM,BASE_MSGTYPE_EACTION_ENUM,BASE_MSGTYPE_EOBJECT_ENUM}
...
BASE_MESSAGE_FIELD.message_type = BASE_MESSAGE
...
BASE.nested_types = {BASE_PING, BASE_REGISTER, BASE_REGISTERED, BASE_MESSAGE, BASE_COORDS, BASE_MOVE, BASE_ACTION, BASE_OBJECT}
...
Base.Message = protobuf.Message(BASE_MESSAGE)
